...
namespace Infinity_TD
{
    class Combinator
    {
        public enum Combination { INVALID, FIRE_ARROW, FLAMETHROWER, TORNADO } //TODO: ADICIONAR OUTRAS TORRES
        ...
        {
            recipeArray[1] = new Recipe(Runes.FIRE, Runes.FIRE, Runes.FIRE, Combination.FIRE_ARROW);
            recipeArray[2] = new Recipe(Runes.AIR, Runes.AIR, Runes.FIRE, Combination.FLAMETHROWER);
            recipeArray[3] = new Recipe(Runes.AIR, Runes.AIR, Runes.AIR, Combination.TORNADO);
            //TODO: FAZER OUTROS RECIPES
        }

        //VERIFICA A COMBINAÇÃO DE RUNAS E RETONRA A TORRE EQUIVALENTE A ELAS
