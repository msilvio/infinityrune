...
namespace Infinity_TD
{
    class PoisonTower : Tower
    {
        ...
        //    : base(game, @"corrosive rune", @"corrosive", damage, position, fireRate, new Effect()) { }

        public override void Initialize(Game game, float damage, Vector2 position, float fireRate)
        {
            base.Initialize(game, @"corrosive rune", @"corrosive", damage, position, fireRate, new BlackHoleEffect());
        }
